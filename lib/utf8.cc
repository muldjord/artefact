...
Pentominos::UTF8::UTF8(std::string encoding)
{
...
std::string Pentominos::UTF8::encode(std::string s)
{
  std::string ret;
...
std::string Pentominos::UTF8::decode(std::string s)
{
  std::string ret;
...
{
  try {
    Pentominos::UTF8 utf8("ISO-8859-1");

    std::string a = "AaBbÆØÅæøå";
    printf("a [%s]\n", a.c_str());
