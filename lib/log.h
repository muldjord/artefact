...
#include <string>
#define LOG(m) (Pentominos::log(__FILE__,__LINE__,m))
...
namespace Pentominos {
  ...
  /**
   * Appends a message to syslog with a line number and file reference.
   * @see log(std::string)
   * @param message An STL string containing the string to be appended
   * @param line Line number (generated by compiler)
   * @param file File name (generated by compiler)
   */
//  void log(std::string message, int line, std::string file);
};
